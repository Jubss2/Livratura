...
export const createGrupoDeLeituraController = async (req: Request, res: Response) => {
  const { nome,dataCriacao,dataEncontro,tituloLivro,usuarios } = req.body;
  const newGrupoDeLeitura = await grupoDeLeituraRepository.createGrupoDeLeitura({ nome,dataCriacao,dataEncontro,tituloLivro,usuarios });
...
export const updateGrupoDeLeituraController = async (req: Request, res: Response) => {
  ...
  const { nome,dataCriacao,dataEncontro,tituloLivro,usuarios } = req.body;
  try {
    const updatedGrupoDeLeitura = await grupoDeLeituraRepository.updateGrupoDeLeitura(grupo, { nome,dataCriacao,dataEncontro,tituloLivro,usuarios });
